...
## 🚀 v2.5.1 更新說明
本版本重點優化字幕切分與斷句策略：
* **Whisper 原生語意 Segment 優先**：[v2.5.1] 徹底解決舊版在精準時間軸模式下強行跨句拼接後亂切導致的破碎斷句問題。100% 尊重 Whisper 解碼器原本的最自然語音段落切割，微調單字級毫秒時間軸。
...
* **自然語意與停頓斷句策略 (Segmentation Strategy)**：改採語音停頓與標點符號自然斷句，摒棄硬性字數切分，徹底避免語意碎裂與詞彙遭中斷切開。
